...
- How we can use linear models to investigate whether the mean of a variable is varying with some predictor x, be it a continuous or categorical variable.
...
Warton: "There are assumptions when making inferences—you need to know what they are and to what extent violations of them are important (to the validity and efficiency of your inferences). Independence, mean, and variance assumptions tend to be important for validity, distributional assumptions not so much, but skew and outliers can reduce eﬃciency.

Bias
Efficiency -- an efficient estimator provides more precise estimates of the parameter.
