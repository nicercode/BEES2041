...
The binomial distribution is used to model the number of successes in a fixed number of trials. The distribution has two parameters: the number of trials $n$ and the probability of success $p$. It generates a series of 0s and 1s, where 1 represents a success.

For exmaple, we can simulate 10 trials with a probability of success of 0.9:
...
For exmaple, we can the number of events in 10 sampling events, 
