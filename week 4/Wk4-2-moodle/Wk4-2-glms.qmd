...
If all the assumption checks are okay, we can have a look at the results the model gave us. The two main functions for inference are the same as for linear models: `summary()`, `paramaters()`.
...
```{r}
mites <- read_csv("https://raw.githubusercontent.com/QCBSRworkshops/workshop06/fe88f6684fa59663e9d5a1591ab5c3d9315d0284/book-fr/mites.csv")

write_csv(mites, "week 4/Wk4-2-moodle/data/mites.csv")
...
```{r}
faramea <- read_csv("https://raw.githubusercontent.com/QCBSRworkshops/workshop06/fe88f6684fa59663e9d5a1591ab5c3d9315d0284/book-fr/faramea.csv")

write_csv(faramea, "week 4/Wk4-2-moodle/data/faramea.csv")
