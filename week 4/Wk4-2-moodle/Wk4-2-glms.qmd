...
These output is interpreted in a similar manner as for linear model
...
Using the `mites` data, model the abundance of the species `Galumna` as a function of water content `WatrCont`.
