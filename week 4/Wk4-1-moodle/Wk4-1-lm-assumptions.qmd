...
2. Based on you plot of the raw data, comment on any problems you see in fitting this linear model to these data.
...
Load the data file `data/Amphipod.fecundity.csv` and choose a plot to visualise egg number per brood.
...
Load the data file `data/riverflow.csv` and choose a plot to visualise the relationship between density of fish larvae.
...
Load the data file `data/koalas.csv` and choose a plot to visualise the number of koalas observed and years since fire.
