...
-   practise interpreting the outputs of models.
...
![Image credit: ](images/r-learners.png){width="80%"} <br>
...
Let's try fitting our model again using our transformed variables.
...
We have not provided the step-by-step instructions or R code for you to complete these exercises. Use the knowledge you've gained so far and apply it here. Make use of your saved code from the previous pracs and the worked example above if you need some guidance.
