...
> This dataset has some difficult variable names.`clean_names()` from the package `janitor` may be useful here. You might need to install the package first.
...
`r cloze("The majority of annual lamina growth in stalagmites is really slowly" c("The majority of annual lamina growth in stalagmites is really fast", "The majority of annual lamina growth in stalagmites is really slowly", "There's no annual lamina growth in stalagmites"))`
...
`r cloze("The annual growth of all lamina samples are highly variable", c("The annual growth of all lamina samples are very similar", "The annual growth of all lamina samples are highly variable"))`
...
You'll need to extract data for the samples numbers in black with `seq_id` before plotting. 
