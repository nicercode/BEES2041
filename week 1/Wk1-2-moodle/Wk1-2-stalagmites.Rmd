...
**Question: Did you notice any errors in the dataset? There is one really weird value. Which is it?**
...
```{r}
data_sites <- read_xlsx("data/staligmites/Tables.xlsx") |> clean_names()
```
