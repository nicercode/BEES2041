...
Using the functions you've learned so far in this prac (remember you can get help with functions using `?function`, e.g. `?mean`), try answer the following questions:
