...
![R complains in red](first-error.png) <br> Getting errors in R are a common experience and they're totally harmless. The error messages usually gives you some clues as to what R is complaining about.
...
![Loading tidyverse`](library_tidyverse.jpg){width=60%}
