...
Each dataset is associated with its own Quarto document (`WkX-X-XX.qmd`, `WkX-X-XX.qmd`). Within each Quarto doc there are several challenges for you to complete on your own devices in order to **answer the questions on Moodle**.
