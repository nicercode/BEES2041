...
where $y_{1j}$ and $y_{2j}$ are the values of variable $j$ in sample 1 and 2; $p$ is the number of variables
...
On the Maroubra field trip, multivariate data were collected to investigate the species composition of the intertidal community living in rock pools to neighbouring rocky habitats that were emergent at low tide.
