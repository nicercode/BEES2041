...
## 7b) What do the multivariate tests and their associated probabilities tell you about the differences in species composition among nutrient treatments? Use the pairwise tests to establish which treatments differ from which. {type=essay}
...
## 11b) Comparing all your classification or ordination plots, discuss which technique best visualises the patterns in metal contamination among sites. Do any clearly identify sites close to the sewage dump? {type=essay}
