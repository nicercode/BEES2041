...
Principal components analysis produces a lot of graphical and numerical output, which can explore by further examining the object (`leaf_pca`) we just created.
...
metals.pca <- princomp(std_HM, cor = FALSE)
