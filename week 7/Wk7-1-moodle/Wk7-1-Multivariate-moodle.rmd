...
output:
  moodlequiz::moodlequiz:
    replicates: 1
moodlequiz:
  category: Week 7-1 Multivariate methods
editor_options:
  chunk_output_type: console
---

```{r,  echo=FALSE, message=FALSE, warning=FALSE, fig.show=FALSE}
# webr counter
...
-   Create and interpret an **multi-dimensional scaling (MDS)** plot
...
<h3>1) Similarity coefficients</h3>
...
<h3>1a) What are the samples and what are the variables?</h3>
...
<h3>1b) Summarise the relationships among samples using the Pearson correlation coefficient</h3>
...
<h3>1c) Summarise the relationships among samples using Euclidean distance</h3>
...
<h3>2) Heavy metals in sediments</h3>
...
Now we can use the `dist()` function again to create the **similarity matrix**, using the **Euclidean distance** as our similarity coefficient.
...
<h3>2a) What does the stress value represent?</h3>
...
<h3>2b) Which site is least similar to any other site?</h3>
...
<h3>2c) Can you see any patterns in the similarity among sites that you can relate to the sampling design? Which sites are most similar to the dump site? </h3>
...
<h3>3) Nutrient enrichment experiment</h3>
...
<h3>3a) Does the ordination distinguish between experimental treatments? Describe the patterns in the plot </h3>
...
<h3>4) Species composition in rock pools</h3>
...
<h3>4a) Does the ordination plot suggest any differences in species composition between rock pools and neighbouring emergent habitats? </h3>
...
<h3>4b) How confident are you that the MDS plot effectively represents the relationships among all samples in the multivariate data set? </h3>
...
<h3>5) Cluster analysis: Heavy metals in sediments</h3>
...
<h3>5c) Does the cluster analysis suggest any effects of the sewage dump </h3>
...
<h3>6) To transform or to standardise?</h3>
...
<h3>6a) Make some notes on how the relationships between sites are altered by standardising the variables </h3>
