...
## Example: Tree height vs leaf area
...
Now get to work! Unlike the example above, you don't need to fit the simple model first. Just go straight to fitting the model with random slopes model. 
