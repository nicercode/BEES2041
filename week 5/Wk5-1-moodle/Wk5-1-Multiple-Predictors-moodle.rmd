...
output:
  moodlequiz::moodlequiz:
    replicates: 1
moodlequiz:
  category: Introduction to Linear Regression with Multiple predictors
editor_options:
...
> You will be working in your own devices today. Load the following packages, you should have these installed already
