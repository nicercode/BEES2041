...
output:
  moodlequiz::moodlequiz:
    replicates: 1
moodlequiz:
  category: Week 5-1 multiple predictors
editor_options:
...
![](images/continuous-discrete.png){width=60%}  <br>
...
![](images/palmer_penguins.png){width=60%}  <br>
...
<h3>Report on the main effect of `species` {type=essay}</h3>
...
<h3>Report on the contrasts of `species` {type=essay}</h3>
...
![](images/sessile.jpg){width=50%}  <br>
...
![](images/Urchins.jpg){width=60%} <br>
...
![](images/bill_dimensions.png){width=50%}  <br>
