...
### Use the `select` function to choose columns i.e. variables
...
<h4>Compute summary statistics by group</h4>

We often want summarise certain variables for particular groups in our data. For example, the average tree canopy cover from different study sites or median house prices of different states. These are classic examples of the `split-apply-combine` paradigm.
