...
![Schematic showing splitting og data by group, applying some sort of operation, then combining the results together](split-apply-combine.png){width=80% align='center'}
<br>
