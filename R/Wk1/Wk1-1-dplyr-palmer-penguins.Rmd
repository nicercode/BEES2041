...
> Learn more from [the dplyr guide](https://dplyr.tidyverse.org/articles/dplyr.html) is really comprehensive! 
...
What if we want to filter on some numeric variable? This is where **relational operators** like `>` and `<` come in. These are useful for selecting ranges in your data.
