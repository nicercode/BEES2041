...
output: 
  moodlequiz::moodlequiz:
    replicates: 1
moodlequiz:
  category: "Week 1-2 tidyverse"
editor_options: 
  chunk_output_type: console
---

The purpose of this quiz is to get some hands-on experience with data manipulation an R package `dplyr`. Recall from last prac an R package is a set of related functions that help you get a specific job done. 
...
`palmerpenguins` itself is an R package so we will also need to load that into R. 
