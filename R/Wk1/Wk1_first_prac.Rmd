...
There are `r`` rows and `r` columns

```{r}
dim(stalagmite_data_nice_names)
```
...
**What type of variable is `lam_age_bp_0_1950ad`?** `r cloze("integer", c("complex number", "integer", "logical", "numeric"))`
