...
R has its unique way of classifying data. Data structures are fundamental to working with data in R as they are the objects you will dealing with them regularly.

There are 4 common data types in R: 

- character   \`c("calico", "tabby", "black")\` 
- numeric      
    - double, numbers containing decimals, default for all numbers in R \`c(200.34, 190.57, 195.83, 197.32)\`      
    - integer, whole numbers    \`c(5L, 1L, 6L, 8L, 10L)\`
- logical     \`c(TRUE, TRUE, TRUE, FALSE, TRUE, TRUE)\`
- complex     \`c(1+4i, 2+7i)\`

We can use functions \`class()\`, \`typeof()\`, \`str()\` to figure out what type of data you are working with.
