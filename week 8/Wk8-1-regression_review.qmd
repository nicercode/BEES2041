---
title: "Review: expressing statistical results"
output: 
...
<h1>Reviewing how to express statistical results.</h1>
...
![](images/height-rainfall_regression.jpg){width=70%} <br>
...
<h4>Ways to express the results</h4>

For each of the following select TRUE if this is a good way to express the statistical results and FALSE if it could be improved upon.
