...
The first challenge a baby turtle faces after hatching is to reach the surface of the sand, and then the ocean. Davey thought it would be good to know roughly how long this takes. However, he couldn't find any data on this. So he decided to collect some data himself. 

Davey has collected data on XX baby turtles, using some collar accelerometers he attached to the turtles as they hatch. 
