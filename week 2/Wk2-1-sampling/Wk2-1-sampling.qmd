...
<!-- ![Artwork by @allison_horst](images/nice-R.png){width=70%} --> <br>
...
![Image: Davey Dor](images/pics/DaveyDor.jpeg){width=80%}
...
![Image: Davey Dor](images/pics/turtle.jpeg)
...
![The t-distribution](images/https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Student_t_pdf.svg/650px-Student_t_pdf.svg.png){width=50%}
...
From the data above, you can see the estimate of the mean time it takes for baby turtles to reach the surface (70.1 hr), and a confidence interval for the mean (from 57.5-82.76 hrs). The 95% confidence interval tells us it is likely that the true mean time it takes for baby turtles to reach the surface is between 57.5 and 82.76 hours.
...
![Collecting soil samples](images/https://media.news.climate.columbia.edu/wp-content/uploads/2018/09/soil-sampling-1300x975.avif){width=50%}
...
![Chinstrap penguin. Image: wikipedia](images/https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/South_Shetland-2016-Deception_Island–Chinstrap_penguin_%28Pygoscelis_antarctica%29_04.jpg/440px-South_Shetland-2016-Deception_Island–Chinstrap_penguin_%28Pygoscelis_antarctica%29_04.jpg){width=50%}
...
![Adelie penguin. Image: wikipedia](images/https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Hope_Bay-2016-Trinity_Peninsula–Adélie_penguin_%28Pygoscelis_adeliae%29_04.jpg/800px-Hope_Bay-2016-Trinity_Peninsula–Adélie_penguin_%28Pygoscelis_adeliae%29_04.jpg){width=50%}
...
![Gentoo penguin.  Image: wikipedia](images/https://upload.wikimedia.org/wikipedia/commons/thumb/0/00/Brown_Bluff-2016-Tabarin_Peninsula–Gentoo_penguin_%28Pygoscelis_papua%29_03.jpg/1202px-Brown_Bluff-2016-Tabarin_Peninsula–Gentoo_penguin_%28Pygoscelis_papua%29_03.jpg){width=50%}
