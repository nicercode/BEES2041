...
To compute means and their relative CI we will use `estimate_means()`. This is loaded as of the `easystats` package, but here we will just laod a component of `easystats`.
