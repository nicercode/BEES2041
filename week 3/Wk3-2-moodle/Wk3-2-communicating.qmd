...
- remove the adjusted R² value if you don't think it's relevant
...
We can filter out the NA penguins using `filter()`. We can also change the labels for the `facet_wrap` using `labeller`.
