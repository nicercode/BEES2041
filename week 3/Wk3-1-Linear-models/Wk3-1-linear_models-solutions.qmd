...
A relatively small value in our `F value` means that we have more `r cloze("noise relative to signal", c("noise relative to signal", "signal relative to noise"))` in our data.

1. Interpret the intercept of your model. What does it represent?

The intercept in our model represents the mean of spray `r cloze("A", c("A", "B", "C", "F", "D", "E", "F"))`
