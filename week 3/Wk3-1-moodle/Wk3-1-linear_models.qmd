...
> How do I know whether there is a treatment group effect?

### Analysis of Variance (ANOVA)

So does `temp_treatment` have an effect on `smr`? 
...
Let's take a look at the `parameters()` output. Looks different huh? 
