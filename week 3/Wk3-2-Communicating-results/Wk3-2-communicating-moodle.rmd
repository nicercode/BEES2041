...
![Image credit: Hadley Wickham [R 4 Data Science](images\https://r4ds.hadley.nz/)](images/the-whole-game-communicate.png){width = 60%} <br>
...
# load packages from the tidyverse (without loading the whole thing)
library(dplyr)
library(readr)
...
<h3>Written description of findings</h3>
...
<h3>Presenting the results of statistical tests</h3>
...
<h3>Introducing the `report` function</h3>
...
<h3> Display items in the results section</h3>
...
<h3>Graphical representation of findings</h3>
...
<h3>Presenting measures of variation when plotting categorical predictor variables</h3>
...
![](images\images/example_se.png){width=60%} <br>
...
To compute means and their relative CI, we will use `estimate_means()`. This is loaded as part of the `easystats` package, but here we will just load a component of `easystats`.
...
<h3>Creating a panel of plots</h3>
